...
**v0.1.9**：首頁加入一隻手繪 SVG 吉祥物——白色圓潤蛋形身體、兩隻小腳、腮紅、笑臉，站在「現在該做什麼」畫面的正中央，並有輕輕的上下晃動動畫（新增 `src/components/home/NearliMascot.tsx`）。這是純視覺層的新增（一個新的可重用元件＋一小段 CSS 動畫關鍵影格），沒有新增任何資料、頁面或商業邏輯。
